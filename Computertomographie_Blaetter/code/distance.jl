function distance(x,y,nx,ny,x0,x1,y0,y1,vx,vy)
...
i,j,valid = getij(x, y, paramsx0,paramsy0,paramsx1,paramsy1,paramsdx,paramsdy,paramsnx,paramsny);
I =[]; J = []; L = [];
while (valid)
    I = [I,i] ;
    J = [J,j];
    lasti = i;
    lastj = j;
    northy, eastx, southy, westx = getwallpositions(i, j, paramsx0,paramsy0,paramsx1,paramsy1,paramsdx,paramsdy,paramsnx,paramsny);
